function [hfo,ic1,EEG,error_flag]=ez_cudaica_fripple_putou_e2(eeg_data,samplingrate);
...
eeg_data=ez_eegfilter(eeg_data,200,600,2000);
...
[EEG.icaweights, EEG.icasphere, mods, error_flag] = cudaica_e1(EEG.data(:,:), 'lrate', 0.001)
if error_flag==0
