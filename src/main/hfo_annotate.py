...
2) mne python module.
3) trcio python module

Output: 
- DSP monopolar/bipolar outputs as matfiles get saved in the corresponding 
directory. This is set in getPaths() function, within config.py.
...
import argparse
import os #to be removed once we fully remove matlab code
