function mat2trc32_m2k_f(patient_id,file_block)
load(['/home/tomas-pastore/ez_detect/putou/mp_temp_trc/eeg_2k_f_' file_block '.mat'])
...
trcfile='/home/tomas-pastore/ez_detect/putou/mp_temp_trc/EEG_1_f.TRC'
fid=fopen(trcfile,'r+');
if fid==-1
...
name=   'xxxxx               '
eeg_id=[patient_id '_m6_' file_block];
...
fclose(fid);
trcfilename=[patient_id '_m6_' file_block '.TRC'];
