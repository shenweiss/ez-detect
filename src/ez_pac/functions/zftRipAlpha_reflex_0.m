function [results] = zftRipAlpha_reflex_0(varargin)
% zftRipAlpha_reflex_0.m by Zachary J. Waldman
%
% Fast ripple detector function used as the upper frequency reflex test in
% the ripple detector zRipAlpha_0.m
% Input:
