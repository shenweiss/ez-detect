...
classdef MonopolarDspToolbox < EzDetectDspToolbox
	...
	methods
		function dsp_monopolar_output = cudaicaFailureHandle(Ez, ez_tall_m, ez_tall_bp, metadata, ez_top_in_dir)
			dsp_monopolar_output = cudaicaFailureHandle_(ez_tall_m, ez_tall_bp, metadata, ez_top_in_dir);
		end
...
function dsp_monopolar_output = cudaicaFailureHandle_(ez_tall_m, ez_tall_bp, metadata, ez_top_in_dir)
