...
if ~isempty(eeg_bp)
    ...
    system(['rm -f /home/tpastore/hfo_engine_1/bp_temp_trc/eeg_2k_a_' file_block '.mat']);
    system(['rm -f /home/tpastore/hfo_engine_1/bp_temp_trc/eeg_2k_b_' file_block '.mat']);
    system(['rm -f /home/tpastore/hfo_engine_1/bp_temp_trc/eeg_2k_c_' file_block '.mat']);
    system(['rm -f /home/tpastore/hfo_engine_1/bp_temp_trc/eeg_2k_d_' file_block '.mat']);
    system(['rm -f /home/tpastore/hfo_engine_1/bp_temp_trc/eeg_2k_e_' file_block '.mat']);
    system(['rm -f /home/tpastore/hfo_engine_1/bp_temp_trc/eeg_2k_f_' file_block '.mat']);
    system(['rm -f /home/tpastore/hfo_engine_1/bp_temp_trc/eeg_2k_g_' file_block '.mat']);
    ...
    for i=1:num_trc_blocks
        if i==1
            ...
            save(['/home/tpastore/hfo_engine_1/bp_temp_trc/eeg_2k_a_' file_block '.mat'],'eeg');
            system_command=['/home/tpastore/hfo_engine_1/executable/mat2trc32_bp2k_a' ' ' file_id ' ' file_block ' &'];
        ...
        if i==2
            ...
            save(['/home/tpastore/hfo_engine_1/bp_temp_trc/eeg_2k_b_' file_block '.mat'],'eeg');
            system_command=['/home/tpastore/hfo_engine_1/executable/mat2trc32_bp2k_b' ' ' file_id ' ' file_block ' &'];
            system(system_command);
        ...
        if i==3
            ...
            save(['/home/tpastore/hfo_engine_1/bp_temp_trc/eeg_2k_c_' file_block '.mat'],'eeg');
            system_command=['/home/tpastore/hfo_engine_1/executable/mat2trc32_bp2k_c' ' ' file_id ' ' file_block ' &'];
            system(system_command);
        ...
        if i==4
            ...
            save(['/home/tpastore/hfo_engine_1/bp_temp_trc/eeg_2k_d_' file_block '.mat'],'eeg');
            system_command=['/home/tpastore/hfo_engine_1/executable/mat2trc32_bp2k_d' ' ' file_id ' ' file_block ' &'];
            system(system_command);
        ...
        if i==5
            ...
            save(['/home/tpastore/hfo_engine_1/bp_temp_trc/eeg_2k_e_' file_block '.mat'],'eeg');
            system_command=['/home/tpastore/hfo_engine_1/executable/mat2trc32_bp2k_e' ' ' file_id ' ' file_block ' &'];
            system(system_command);
        ...
        if i==6
            ...
            save(['/home/tpastore/hfo_engine_1/bp_temp_trc/eeg_2k_f_' file_block '.mat'],'eeg');
            system_command=['/home/tpastore/hfo_engine_1/executable/mat2trc32_bp2k_f' ' ' file_id ' ' file_block ' &'];
            system(system_command);
        ...
        if i==7
            ...
            save(['/home/tpastore/hfo_engine_1/bp_temp_trc/eeg_2k_g_' file_block '.mat'],'eeg');
            system_command=['/home/tpastore/hfo_engine_1/executable/mat2trc32_bp2k_g' ' ' file_id ' ' file_block ' &'];
            system(system_command);
