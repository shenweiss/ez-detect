function [output_fname] = eztop_alpha_putou04(file_data,metadata,montage);
% ezTopAlpha_dev_0.m
% Created By Zachary J. Waldman TJU 2017 Patent Pending
%
...
output_fname = ['/home/mgatti/ez_detect/putou/ez_top/out_data/' 'ezTop_' metadata.patient_id fname_var metadata.file_block '.mat']
...
save(output_fname,'ftRonO','ftTRonS','RonO','TRonS','Total_FRonS','Total_ftFRonS','Total_ftRonO','Total_ftTRonS','Total_RonO','Total_TRonS')
