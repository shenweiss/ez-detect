...
% for aa = 1:size(d1)
for aa = 5
%     d2 = dir(['/home/mgatti/zac/eztop/in_data/' d1(aa).name '/']);
%     d2(1:2,:) = [];
%     for bb = 1:size(d2,1)
    for bb = 1
        pat = d1(aa).name;
        load(['/home/mgatti/zac/398/' d1(aa).name])
%         pat = d2(bb).name;
%         load(['/home/mgatti/zac/eztop/in_data/' d1(aa).name '/' pat])
        if strcmp('p', pat(end-6))
            file_data = DSP_data_bp;
        elseif strcmp('m', pat(end-6))
            file_data = DSP_data_m;
        end
%         mkdir('/home/mgatti/zac/eztop/in_data/IO_output/', [d1(aa).name '_output/']);
%         mkdir(['/home/mgatti/zac/eztop/in_data/IO_output/' d1(aa).name '_output/'], 'variables/');

        mkdir('/home/mgatti/zac/eztop/error_files_output/');
        mkdir('/home/mgatti/zac/eztop/error_files_output/variables/');

        output1 = ['/home/mgatti/zac/eztop/error_files_output/variables/var_' pat];
        output1 = ['/home/mgatti/zac/eztop/error_files_output/ezTop_' pat];
