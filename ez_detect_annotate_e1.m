...
if montage == 0
    ...
    for i=1:num_trc_blocks
        if i==1
            ...
            evt_1=strcat('/home/mgatti/hfo_engine_1/TRC_out/',evt_1);
            fid1=fopen(evt_1,'wt');
            fclose(fid1);
        end;
        if i==2
            ...
            evt_2=strcat('/home/mgatti/hfo_engine_1/TRC_out/',evt_2);
            fid2=fopen(evt_2,'wt');
            fclose(fid2);
        end;
        if i==3
            ...
            evt_3=strcat('/home/mgatti/hfo_engine_1/TRC_out/',evt_3);
            fid3=fopen(evt_3,'wt');
            fclose(fid3);
        end;
        if i==4
            ...
            evt_4=strcat('/home/mgatti/hfo_engine_1/TRC_out/',evt_4);
            fid4=fopen(evt_4,'wt');
            fclose(fid4);
        end;
        if i==5
            ...
            evt_5=strcat('/home/mgatti/hfo_engine_1/TRC_out/',evt_5);
            fid5=fopen(evt_5,'wt');
            fclose(fid5);
        end;
        if i==6
            ...
            evt_6=strcat('/home/mgatti/hfo_engine_1/TRC_out/',evt_6);
            fid6=fopen(evt_6,'wt');
            fclose(fid6);
        end;
        if i==7
            ...
            evt_7=strcat('/home/mgatti/hfo_engine_1/TRC_out/',evt_7);
            fid7=fopen(evt_7,'wt');
            fclose(fid7);
        end;
    end;
