...
forfiles /p .\executable\ /c "cmd /c @isdir equ FALSE if not @ext==\"keep\"  del /q @file"
...
forfiles /p .\temp_pythonToMatlab_dsp_MATLAB\ /c "cmd /c @isdir equ FALSE if not @ext==\"keep\"  del /q @file"
