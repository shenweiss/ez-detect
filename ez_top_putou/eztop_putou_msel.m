function [output_fname] = eztop_putou_msel(fileData,file_id)
load(fileData)
fname_var='_bp_';
output_fname = ['ezTop_' file_id fname_var '.mat'];
fileData=DSP_data_bp;
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
clearvars -except fileData vname_var output_fname
tic
% Load Clips
...
output_fname=['/home/tpastore/ez_detect/putou/ez_top_putou/MSEL_ez_top_out/' output_fname];
