...
load(['/home/mgatti/ez_detect/putou/mp_temp_trc/eeg_2k_d_' file_block '.mat'])
...
trcfile='/home/mgatti/ez_detect/putou/mp_temp_trc/EEG_1_d.TRC'
fid=fopen(trcfile,'r+');
if fid==-1
...
name=   'xxxxx               '
eeg_id=[patient_id '_m4_' file_block];
