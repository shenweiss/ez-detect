...
if error_flag==0 % error flag 1
    ...
    if numel(b)<numel(metadata.m_chanlist)-10 % if number of bad electrodes are not the vast majority
        ...
        system(['rm -f /home/mgatti/hfo_engine_1/mp_temp_trc/eeg_2k_a_' file_block '.mat']);
        system(['rm -f /home/mgatti/hfo_engine_1/mp_temp_trc/eeg_2k_b_' file_block '.mat']);
        system(['rm -f /home/mgatti/hfo_engine_1/mp_temp_trc/eeg_2k_c_' file_block '.mat']);
        system(['rm -f /home/mgatti/hfo_engine_1/mp_temp_trc/eeg_2k_d_' file_block '.mat']);
        system(['rm -f /home/mgatti/hfo_engine_1/mp_temp_trc/eeg_2k_e_' file_block '.mat']);
        system(['rm -f /home/mgatti/hfo_engine_1/mp_temp_trc/eeg_2k_f_' file_block '.mat']);
        system(['rm -f /home/mgatti/hfo_engine_1/mp_temp_trc/eeg_2k_g_' file_block '.mat']);
        ...
        for i=1:num_trc_blocks
            if i==1
                ...
                save(['/home/mgatti/hfo_engine_1/mp_temp_trc/eeg_2k_a_' file_block '.mat'],'eeg');
                system_command=['/home/mgatti/hfo_engine_1/executable/mat2trc32_m2k_a' ' ' file_id ' ' file_block ' &'];
            ...
            if i==2
                ...
                save(['/home/mgatti/hfo_engine_1/mp_temp_trc/eeg_2k_b_' file_block '.mat'],'eeg');
                system_command=['/home/mgatti/hfo_engine_1/executable/mat2trc32_m2k_b' ' ' file_id ' ' file_block ' &'];
                system(system_command);
            ...
            if i==3
                ...
                save(['/home/mgatti/hfo_engine_1/mp_temp_trc/eeg_2k_c_' file_block '.mat'],'eeg');
                system_command=['/home/mgatti/hfo_engine_1/executable/mat2trc32_m2k_c' ' ' file_id ' ' file_block ' &'];
                system(system_command);
            ...
            if i==4
                ...
                save(['/home/mgatti/hfo_engine_1/mp_temp_trc/eeg_2k_d_' file_block '.mat'],'eeg');
                system_command=['/home/mgatti/hfo_engine_1/executable/mat2trc32_m2k_d' ' ' file_id ' ' file_block ' &'];
                system(system_command);
            ...
            if i==5
                ...
                save(['/home/mgatti/hfo_engine_1/mp_temp_trc/eeg_2k_e_' file_block '.mat'],'eeg');
                system_command=['/home/mgatti/hfo_engine_1/executable/mat2trc32_m2k_e' ' ' file_id ' ' file_block ' &'];
                system(system_command);
            ...
            if i==6
                ...
                save(['/home/mgatti/hfo_engine_1/mp_temp_trc/eeg_2k_f_' file_block '.mat'],'eeg');
                system_command=['/home/mgatti/hfo_engine_1/executable/mat2trc32_m2k_f' ' ' file_id ' ' file_block ' &'];
                system(system_command);
            ...
            if i==7
                ...
                save(['/home/mgatti/hfo_engine_1/mp_temp_trc/eeg_2k_g_' file_block '.mat'],'eeg');
                system_command=['/home/mgatti/hfo_engine_1/putou/executable/mat2trc32_m2k_g' ' ' file_id ' ' file_block ' &'];
                system(system_command);
